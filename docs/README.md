# LMS client documents

Send to the client **before** development.

| Order | File | Purpose |
|-------|------|---------|
| **1** | [01-Existing-LMS-Features-Reference.md](./01-Existing-LMS-Features-Reference.md) | Existing / market-standard LMS features |
...
> Please review the two attached documents:
> 1. **Existing LMS Features** — baseline in the market today  
> 2. **White-Label AI LMS Proposal** — our plan including new AI features under your brand  
>
> Reply with Phase 1 priorities and Section 8 decisions in Document 02.
